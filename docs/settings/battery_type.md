...
>
> Для самозбірок із JK PB BMS, що працюють за протоколом LuxPowerTek, див. [схему CAN/RS485 та адресації BMS](/faq/faq-battery-and-bms#схема-підключення-jk-pb-bms-до-luxpower-sna6000-can-rs485-та-адреси-модулів).
