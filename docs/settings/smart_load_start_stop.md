...
3. **Вимкнення:** Якщо сонце сховається за хмари, і бойлер почне витягувати енергію з акумулятора, то при падінні рівня заряду до `Smart Load End SOC` (наприклад, 60%), інвертор негайно знеструмить цей порт. Таким чином, у вас в батареї гарантовано залишиться 60% заряду на вечір.
