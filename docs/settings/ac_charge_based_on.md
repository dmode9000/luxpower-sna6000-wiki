...
> Вибір режиму в цьому випадному списку — це лише активація логіки. Щоб зарядка фактично запрацювала, вам потрібно задати відповідні пороги старту/зупинки (`Charge Start SOC / Volt` та `Charge End SOC / Volt`), встановити хочаб один з часових проміжків (`Time 1, Time 2, Time 3`), якщо обрано режим із часом, а також вказати максимальний струм заряду від мережі у параметрі `AC Charge Battery Current`.
